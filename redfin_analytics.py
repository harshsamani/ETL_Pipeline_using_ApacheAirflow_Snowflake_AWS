...
# s3 buckets
target_bucket_name = 'redfin-transform-data'

# url link for data - https://www.redfin.com/news/data-center/
...
def transform_data(task_instance):
    ...
    # replacing commas from 'city' column to ''
    ...
    # changing period_begin and period_end to date time object to extract years and month.
...
with DAG('redfin_analytics_dag',
        ...
        load_to_s3 = BashOperator(
            ...
            bash_command = 'aws s3 mv {{ ti.xcom_pull("tsk_extract_redfin_data")[0]}} s3://your_s3_name_for_storing_raw_data',
        )
